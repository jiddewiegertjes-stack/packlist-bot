...
// ---------- SYSTEM PROMPT (multiline veilig) ----------
...
module.exports = async (req, res) => {
  ...
  // ✅ Bouw 1 string voor user message (Chat Completions verwacht string)
  ...
  // CORS staat al, maar extra defensief:
